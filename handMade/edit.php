                        ...
                        <div class="card-body">
                            ...
                            <form onsubmit="return checkForm()" name="form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="space_time" name="space_time" aria-describedby="emailHelp" placeholder="Enter address" value="<?=htmlentities($row['space_time'])?>">
                                    <small id="emailHelp" class="form-text"></small>
                                </div>
                                <div class="form-group">
